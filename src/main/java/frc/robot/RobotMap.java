...
public class RobotMap {
    ...
    public static final double frontLimeHeight=38.5;//all inches
    public static final double backLimeHeight=0;
    public static final double frontLimeAngle=11;
    public static final double backLimeAngle=0;
    public static final double tapeHeight=28.5;
    public static final double tapeDistanceFlat=0;
}
